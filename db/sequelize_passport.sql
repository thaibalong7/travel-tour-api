...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 30, 2019 lúc 04:04 AM
...
(89, '07:00:00', '08:30:00', 1, NULL, NULL, 4, 20, NULL),
(90, '09:00:00', '12:00:00', 1, NULL, NULL, 2, 20, NULL),
(91, '14:00:00', '01:00:00', 1, NULL, NULL, 14, NULL, NULL),
(92, '02:00:00', '14:00:00', 2, NULL, NULL, 12, 20, NULL),
...
INSERT INTO `tours` (`id`, `name`, `description`, `detail`, `featured_img`, `policy`) VALUES
...
(3, '2019-03-24', '2019-03-24', 1, 20, 200000, 0, 74, 'public', 2),
(4, '2019-01-25', '2019-01-25', 2, 20, 215000, 0, 58, 'public', 2),
(5, '2019-04-11', '2019-04-11', 0, 60, 500000, 0, 75, 'public', 3),
(6, '2019-03-08', '2019-03-08', 0, 30, 1500000, 0, 0, 'private', 4),
(7, '2019-03-10', '2019-03-15', 0, 50, 1500000, 0, 47, 'public', 5),
(8, '2019-03-04', '2019-03-06', 0, 60, 7500000, 0, 85, 'public', 6),
(13, '2019-04-19', '2019-04-24', 0, 60, 550000, 0, 47, 'public', 1),
(14, '2019-04-24', '2019-05-07', 9, 60, 500000, 5, 127, 'public', 2),
...
(18, '2019-04-06', '2019-04-06', 0, 25, 300000, 0, 67, 'public', 2),
...
INSERT INTO `users` (`id`, `username`, `fullname`, `password`, `sex`, `address`, `birthdate`, `phone`, `email`, `avatar`, `isActive`, `type`) VALUES
...
--
-- Các ràng buộc cho bảng `verification_token`
--
ALTER TABLE `verification_token`
  ADD CONSTRAINT `verification_token_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
