...
const html_e_ticket_email = (linkTeam, book_tour, linkTourTurn) => {
							...
							<tr>
								<td class="wrapper">
									<table role="presentation" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td>
												<h2 class="align-center">Xác nhận hoàn tiền</h2>
									...
									<table role="presentation" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td>
												...
												<div class="text-bold">Kính gởi quý khách ${cancel_booking.book_tour_history.book_tour_contact_info.fullname},</div>
												<div class="text-margin-request">Quý khách vừa nhận được tiền hoàn lại từ công ty.</div>
	
												<div style="font-weight: bold;margin-top: 30px">Thông tin hoàn tiền: </div>
												<table style="margin-top: 10px">
													<tr>
														<td width="30%">
															Số tiền được hoàn:
														</td>
														<td style="font-weight: bold;font-size: 120%;color:#0f22c9">
															${money_refunded} VNĐ
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td style="font-weight: bold">
															#${cancel_booking.book_tour_history.code}
														</td>
													</tr>
													<tr>
														<td width="30%">
														...
														<td>
															${cancel_booking.book_tour_history.tour_turn.tour.name}
														</td>
													</tr>
												</table>
												<div style="margin-top: 40px">
													Cảm ơn quý khách đã sử dụng dịch vụ của ${company_info.name}!
												</div>
											</td>
										</tr>
									</table>
									<div class="end-mail">
										Email này được gởi tới quý khách ${cancel_booking.book_tour_history.book_tour_contact_info.fullname} vì quý khách đã nhận
										tiền hoàn trả từ ${company_info.name}.
									</div>
								</td>
							</tr>
