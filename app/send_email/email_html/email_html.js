                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td>
                          ...
                          <p>We just want to confirm that you have just registered a Tour Travel account</p>
...
const html_forgetPassword_email = (new_password, linkTeam) => {
    ...
    <body class="">
      <span class="preheader">New password in Tour Travel</span>
      <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="body">
        <tr>
          <td>&nbsp;</td>
          <td class="container">
...
const html_e_ticket = (linkTeam, book_tour, linkTourTurn) => {
	...
	console.log(date_arrive, date_arrive.getDay())
						...
						<table role="presentation" class="main">
							...
							<tr>
								<td class="wrapper">
									...
									<div class="end-mail">
										Email này được gởi tới quý khách ${book_tour.book_tour_contact_info.fullname} vì quý khách đã đặt tour du lịch qua Tour
										Travel.
									</div>
