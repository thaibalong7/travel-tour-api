...
module.exports = {
	up: (queryInterface, Sequelize) => {
		...
		*/
		return Promise.all([
			queryInterface.dropTable('request_cancel_booking').then(() => {
				return queryInterface.createTable('cancel_booking', { // create cancel_booking table
					id: {
						autoIncrement: true,
						primaryKey: true,
	...
	down: (queryInterface, Sequelize) => {
		...
		*/
		return Promise.all([
			queryInterface.dropTable('cancel_booking').then(() => {
				return queryInterface.createTable('request_cancel_booking', { //10. create request_cancel_booking table
					id: {
						autoIncrement: true,
						primaryKey: true,
						type: Sequelize.INTEGER
